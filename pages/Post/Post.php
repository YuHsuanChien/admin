...
$db_file = 'C:\Users\User\Desktop\admin template\why.db';
$dsn = 'sqlite:' . $db_file;
try {
	// 建立 PDO 物件
	$pdo = new PDO($dsn);
		...
		<div class="container-fluid page-body-wrapper">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					...
					<li class="nav-item">
						<a class="nav-link" href="../Group/Group.php">
					...
					<li class="nav-item">
						<a class="nav-link" href="../Page/Page.php">
							<span class="menu-title">頁面</span>
							<i class="mdi mdi mdi-file-outline menu-icon"></i>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../Domain/Domain.php">
					...
					<li class="nav-item">
						<a class="nav-link" href="#">
							<span class="menu-title" style="color: #b66dff;">文章</span>
							<i class="mdi mdi-clipboard-outline menu-icon"></i>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../Web_Component/Web_Component.php">
